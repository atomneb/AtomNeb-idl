...
wavelength=5325.42
list_oii_aeff_data=atm->search_aeff_o_ii_ssb17(atom, ion, case1, wavelength)
...
list_oii_aeff_reference=atm->list_aeff_o_ii_ssb17_references(atom, ion)
...
citation=atm->get_aeff_o_ii_ssb17_reference_citation(atom, ion)
