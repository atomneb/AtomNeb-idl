...
wavelength=5679.56
list_nii_aeff_data=atm->search_aeff_n_ii_fsl13(atom, ion, wavelength)
...
list_nii_aeff_reference=atm->list_aeff_n_ii_fsl13_references(atom, ion)
...
citation=atm->get_aeff_n_ii_fsl13_reference_citation(atom, ion)
