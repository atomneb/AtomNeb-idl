...
nii_rc_data=atm->read_aeff_collection(atom, ion)
nii_rc_data_br=atm->read_aeff_collection(atom, ion, /br)
...
oii_rc_data=atm->read_aeff_collection(atom, ion)
oii_rc_data_br=atm->read_aeff_collection(atom, ion, /br)
...
neii_rc_data=atm->read_aeff_collection(atom, ion)
...
list_cii_aeff_data=atm->search_aeff_collection(atom, ion)
...
list_cii_aeff_reference=atm->list_aeff_collection_references(atom, ion)
...
citation=atm->get_aeff_collection_reference_citation(atom, ion)
