...
function atomnebuttestcase::have_dlm, dlm_name
...
pro atomnebuttestcase::teardown
  compile_opt strictarr
...
function atomnebuttestcase::init, _extra=e
  compile_opt strictarr
...
pro atomnebuttestcase__define
  compile_opt strictarr

  define = { AtomNebUTTestCase, inherits MGutTestCase, $
             nptrs: 0L, $
             nobjs: 0L, $
