...
;+
; NAME:
;     atomneb_list_aeff_collection_references
; PURPOSE:
...
;     atom='c'
;     ion='iii'
;     list_cii_omij_reference=atomneb_list_aeff_collection_references(Atom_RC_file, atom, ion)
;     print,list_cii_omij_reference
;
; INPUTS:
