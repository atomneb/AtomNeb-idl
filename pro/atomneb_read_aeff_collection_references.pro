...
function atomneb_read_aeff_collection_references, Atom_RC_file
;+
...
;+
; NAME:
;     atomneb_read_aeff_collection_references
;
; PURPOSE:
;     This function returns the list of recombination coefficients (Aeff) from the 2nd binary table extension
;     of the FITS data file ('rc_collection.fits').
;
; CALLING SEQUENCE:
;     aeff_data=atomneb_read_aeff_collection_references(Atom_RC_file,)
;
; INPUTS:
...
;            Citation:''}
;
; PROCEDURE: This function is called by atomneb_get_aeff_collection_reference_citation. 
